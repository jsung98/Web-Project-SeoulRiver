  ...
  <button type="button" style = "text-align:center; HEIGHT: 42pt;" class="list-group-item list-group-item-action" onclick="location.href='MainServlet?command=num31'">강서</button>
   ...
   <div class="list-group list-group-horizontal" align="center"
      ...
      <button type="button" class="list-group-item list-group-item-action"
         onclick="location.href='MainServlet?command=num1'">공원소개</button>
      <button type="button" class="list-group-item list-group-item-action "
         onclick="location.href='MainServlet?command=num2'">즐길거리</button>
      <button type="button"
   ...
   <div style="padding: 100px 0px 0px 450px;" class="asd">
      - 한강공원 주차장 홈페이지(광나루) : <a
         href="https://www.ihangangpark.kr/parking/region/region1" class="link-secondary">https://www.ihangangpark.kr</a>
   </div>

   <div style="padding: 50px 0px 0px 450px" class="asd">- 주차장 수 : 3개소,359대 주차가능</div>
   ...
   <div class="map" align="center" style="padding: 50px 300px 0px 300px">
      ...
      <script>
         ...
         mapOption = {
            center : new kakao.maps.LatLng(37.5528, 127.1212), // 지도의 중심좌표
            level : 7
         // 지도의 확대 레벨
         };
         ...
         var arr = new Array();
         arr[0] = [ "광나루1주차장(암사나들목 앞)", 37.5569, 127.1245,
               "서울 강동구 암사동 613-8", "27597289" ];
         arr[1] = [ "광나루2주차장(즈믄길나들목 앞)", 37.5483, 127.1199, "서울 강동구 천호동",
               "25811802" ];
         arr[2] = [ "광나루3주차장(천호대교밑)", 37.5418, 127.1155, "서울 송파구 풍납동 49-2",
               "14562367" ];
         arr[3] = [ "광나루4주차장(풍납지구)", 37.5274, 127.1055, "서울 송파구 신천동 257",
               "17384906" ];
   ...
   <div style="padding: 0px 450px 0px 450px">
      <table class="table  table-bordered">
         ...
         <tr class="table-light" align="center">
            <td>광나루1주차장(암사나들목 앞)</td>
            <td>강동구 암사동 613-11</td>
            <td>1,560</td>
            <td>49</td>
         </tr>
         <tr class="table-light" align="center">
            <td>광나루2주차장(즈믄길나들목 앞)</td>
            <td>강동구 천호동 483-8</td>
            <td>3,040</td>
            <td>119</td>
         </tr>
         ...
         <tr class="table-light table table-borderless" align="center">
            <td>광나루4주차장(풍납지구)</td>
            <td>송파구 신천동 255-1</td>
            <td>1,326</td>
            <td>공사 중</td>
   ...
   <div style="padding: 0px 450px 0px 450px" class="fw-bolder"> * 주차요금은 주차단위구획을 기준으로 징수하며 1구획은 승용자동차를 기준으로 하되, <p class="ss">1구획을 초과하는 자동차에 대하여는 그 점용 구획수에 따라 주차요금 징수</p></div>
...
&nbsp;* 주차장내에 장기간 방치하는 차량은 견인 조치됩니다.<br>
&nbsp;* 차량 멸실 또는 훼손 시 즉시 주차관리원에게 신고하시면 사고원인 조사 후 관리 부주의 책임이 인정되는 경우에 한해 주차장 내 차량사고로 접수하실 수 있습니다.<br>
&emsp;다만, 주차장 이용시간 이외에 발생한 사고에 대해서는 운전자에게 책임이 있습니다.<br>
&nbsp;* 주차요금은 이중감면이 되지 않으며, 감면율이 높은 하나만 적용합니다.<br>
&nbsp;* 운영시간 종료 2시간 이내에 주차하는 자동차에 대해서는 주차요금을 사전에 받을 수 있습니다.<br> &emsp;&nbsp;다만, 운영시간 종료 이전에 나가는 차량은 주차요금 잔액을 반환하여 드리오니 주차관리원에게 영수증을 제시하여 주시기 바랍니다.<br>
&nbsp;* 주차장 안에서 차량을 이용한 영업 또는 광고행위와 차량정비를 할 수 없습니다.<br>
&nbsp;* 주차장 안에서 쓰레기를 버리거나 세차를 하는 경우 과태료(쓰레기 3만원, 세차 50만원)가 부과됩니다.<br>
&nbsp;* <p class="ss">한강공원 수영장, 물놀이장, 캠핑장 이용차량은 별도 감면율(50~60%) 적용을 받지 않습니다.</p></div>
