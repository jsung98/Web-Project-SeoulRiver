...
<div class="list-group list-group-horizontal" align="center" style ="padding:0px 0px 0px 250px">
  <button type="button" class="list-group-item list-group-item-action" onclick="location.href='MainServlet?command=num25'">공원소개</button>
  <button type="button" class="list-group-item list-group-item-action active" onclick="location.href='MainServlet?command=num26'">즐길거리</button>
...
- 한강에 둘러싸여 도심속에 자리잡고 있는 망원수영장은 넓고 쾌적한 공간으로 개방형 샤워장과 세족장 등이 설치되어 있으며, 풀장 주변을 점토 블럭으로 깔아 깨끗하고 편안한 촉감을 느낄 수 있는 웰빙 공간으로 조성되어 있습니다. 여름이면 연인들의 데이트 공간은 물론 가족단위의 물놀이 공간으로 많이 찾는 장소입니다.
<br>
<div class="map" style="padding:20px 300px 0px 0px">
  <img src = "upload/p48.jpg" width = 254 height = 221>
  </div>
<br><br>

<div class=asd>절두산순교기념관</div>
- 절두산순교기념관은 조선말 병인박해 때 순교한 교민들을 기리기 위해 세워진 곳입니다. 양화대교 강북지점에서 동쪽으로 시선을 돌리면 누에가 머리를 든 것 같다하여 잠두봉이라고 부르는 한강변의 절경으로 유명합니다. 현재 순교자기념관에는 순례성당과 순교성인 28인의 초상화, 그리고 한국교회의 발자취를 한눈에 볼 수 있는 수많은 자료와 유물들이 전시되어 있습니다.
<br>
<div class="map" style="padding:20px 300px 0px 0px">
  <img src = "upload/p49.jpg" width = 254 height = 221>
  </div>
  <br><br>
</div>
